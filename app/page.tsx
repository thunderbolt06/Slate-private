  ...
  if (canInstantClassroom) {
    ...
    return (
      <div ref={containerRef} className="relative shrink-0">
        ...
        {dropdownOpen && (
          <div className="absolute right-0 top-12 z-50 min-w-[200px] rounded-2xl border-2 border-[#073b4c]/10 dark:border-[#2a2a2a] bg-white dark:bg-[#1a1a1a] shadow-[4px_4px_0_rgba(7,59,76,0.08)] dark:shadow-[4px_4px_0_rgba(0,0,0,0.5)] overflow-hidden">
            <button type="button" onClick={() => { setDropdownOpen(false); onBasicClassroom(); }}
              ...
              <div className="text-left">
                <p className="font-semibold text-[#073b4c] dark:text-[#f0f0f0] text-xs">Basic Classroom</p>
