      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-full bottom-0 ml-3 w-80 bg-white border-[3px] border-[#073b4c] rounded-2xl shadow-[6px_6px_0_#073b4c] z-[300] overflow-hidden"
          >
            <div className="px-4 py-3 border-b-2 border-[#073b4c]/10 flex items-center justify-between">
              <span className="text-sm font-black text-[#073b4c] uppercase tracking-wide">Notifications</span>
            ...
            <div className="max-h-[360px] overflow-y-auto">
              {notifications.length === 0 ? (
                <div className="py-10 text-center">
                  ...
                  <p className="text-sm font-medium text-[#073b4c]/40">No notifications yet</p>
                </div>
              ) : notifications.map((n) => (
                <button key={n.id} type="button"
                  ...
                  className={cn(
                    ...
                    n.is_read ? 'hover:bg-slate-50' : 'bg-[#ef476f]/5 hover:bg-[#ef476f]/8',
                  )}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {n.body && <p className="text-xs text-[#073b4c]/50 mt-0.5 line-clamp-2">{n.body}</p>}
                    <p className="text-[10px] text-[#073b4c]/30 mt-1">{timeAgo(n.created_at)}</p>
                  </div>
                </button>
              ))}
            </div>
...
function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 h-full z-50 w-64 bg-white dark:bg-[#0f172a] border-r-[3px] border-[#073b4c] dark:border-slate-700 flex flex-col',
      ...
      >
        {/* Logo */}
        <div className="px-5 pt-5 pb-4 border-b-[3px] border-[#073b4c] dark:border-slate-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xl font-black text-[#073b4c] dark:text-slate-100 tracking-[-0.02em]">SLATE UP</span>
            </div>
            <button
              onClick={onMobileClose}
              className="lg:hidden size-7 rounded-full hover:bg-[#f0f4f8] dark:hover:bg-slate-800 flex items-center justify-center transition-colors"
            >
              <X className="size-4 text-[#073b4c] dark:text-slate-400" />
            </button>
          </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active
                    ? 'bg-[#073b4c] text-white shadow-[3px_3px_0_rgba(7,59,76,0.15)]'
                    : 'text-[#073b4c]/55 hover:bg-[#f0f4f8] hover:text-[#073b4c] dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-100',
                )}
              >
        ...
        <div className="border-t-[3px] border-[#073b4c] dark:border-slate-700">
          {/* Utility actions */}
          <div className="px-3 pt-2 pb-2 flex flex-col gap-0.5">
            ...
            {isAdmin && (
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl font-bold text-sm text-[#073b4c]/55 hover:bg-[#f0f4f8] hover:text-[#073b4c] dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-100 transition-all"
              >
          ...
          <div className="px-3 pb-4 pt-1">
            {authLoading ? (
              <div className="flex items-center gap-3 px-4 py-3 rounded-xl border-2 border-[#073b4c]/10 dark:border-slate-700">
                <div className="size-9 rounded-full bg-[#f0f4f8] dark:bg-slate-700 animate-pulse shrink-0" />
                <div className="flex-1 space-y-1.5">
                  <div className="h-3 w-24 bg-[#f0f4f8] dark:bg-slate-700 rounded-full animate-pulse" />
                  <div className="h-2.5 w-32 bg-[#f0f4f8] dark:bg-slate-700 rounded-full animate-pulse" />
                </div>
              </div>
            ) : user ? (
              <button
                onClick={() => setProfileOpen(true)}
                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl border-2 border-[#073b4c]/10 hover:border-[#073b4c]/30 hover:bg-[#f8f9fa] dark:border-slate-700 dark:hover:border-slate-500 dark:hover:bg-slate-800 transition-all group"
              >
                {/* Avatar */}
                <div className="size-9 rounded-full border-2 border-[#073b4c]/20 group-hover:border-[#073b4c]/50 dark:border-slate-600 overflow-hidden shrink-0 transition-all">
                  {avatarUrl ? (
                ...
                <div className="flex-1 min-w-0 text-left">
                  <p className="text-[13px] font-bold text-[#073b4c] dark:text-slate-100 truncate leading-tight">
                    {displayName || 'My Profile'}
                  </p>
                  <p className="text-[11px] text-[#073b4c]/40 dark:text-slate-500 truncate leading-tight mt-0.5">
                    {user.email}
                  </p>
                </div>

                {/* Chevron */}
                <ChevronRight className="size-3.5 text-[#073b4c]/25 group-hover:text-[#073b4c]/50 dark:text-slate-600 dark:group-hover:text-slate-400 shrink-0 transition-colors" />
              </button>
            ) : (
              <button
...
function NewCourseTab({
  ...
  return (
    <div className="max-w-3xl mx-auto w-full">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-black text-[#073b4c] tracking-tight mb-2">
          Create New Course
        </h1>
      ...
      {/* Input card */}
      <div className="w-full rounded-3xl border-[3px] border-[#073b4c] bg-white shadow-[8px_8px_0_#073b4c] transition-all hover:shadow-[10px_10px_0_#073b4c] focus-within:shadow-[10px_10px_0_#073b4c] flex flex-col pb-2">
        <textarea
          ref={textareaRef}
          placeholder={t('upload.requirementPlaceholder')}
          className="w-full resize-none border-0 bg-transparent px-5 pt-5 pb-2 text-base font-medium leading-relaxed placeholder:text-[#073b4c]/40 focus:outline-none min-h-[180px] max-h-[400px] text-[#073b4c]"
      ...
      <div className="mt-8">
        <p className="text-xs font-bold text-[#073b4c]/40 uppercase tracking-widest mb-3">
          Popular Topics
        </p>
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs font-bold rounded-full border-2 border-[#073b4c]/15 text-[#073b4c]/60 hover:border-[#073b4c]/40 hover:text-[#073b4c] hover:bg-[#f0f4f8] transition-all"
            >
              {prompt}
            </button>
          ))}
    ...
    <div
      className={cn(
        ...
        isDragOver
          ...
          : 'border-[#073b4c]/20 dark:border-slate-600 hover:border-[#073b4c]/50 dark:hover:border-slate-400',
      )}
      ...
      >
        ...
        <div className="absolute inset-1.5 grid grid-cols-2 grid-rows-2 gap-1 rounded-xl overflow-hidden">
              ...
              <div key={id} className="bg-slate-200 dark:bg-slate-600 rounded-lg overflow-hidden">
                {slide && thumbWidth > 0 ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <BookOpen className="size-3 text-slate-400 dark:text-slate-500" />
                  </div>
                )}
              </div>
            );
          ...
          {previewIds.length < 4 && Array.from({ length: 4 - previewIds.length }).map((_, i) => (
            <div key={`empty-${i}`} className="bg-slate-100 dark:bg-slate-700 rounded-lg" />
          ))}
        </div>
      ...
      <div className="px-3 py-2.5 flex items-center gap-2">
        {editing ? (
          <input
            ...
            onBlur={commitRename}
            maxLength={60}
            className="flex-1 bg-transparent border-b-2 border-[#8338ec] text-[13px] font-bold text-[#073b4c] dark:text-slate-100 outline-none"
          />
        ) : (
          <p
            className="flex-1 text-[13px] font-bold text-[#073b4c] dark:text-slate-100 truncate cursor-pointer"
        ...
        <button
          ...
          className="shrink-0 size-5 rounded-full bg-[#f0f4f8] dark:bg-slate-700 flex items-center justify-center hover:bg-[#ef476f] hover:text-white transition-colors text-[#073b4c]/30 dark:text-slate-500"
        >
          <X className="size-3" />
        </button>
      </div>
      ...
      <AnimatePresence>
        {expanded && (
          <motion.div
            ...
            className="overflow-hidden border-t-2 border-[#073b4c]/8 dark:border-slate-700"
          >
            <div className="p-2 space-y-1">
              {courses.map((course) => (
                <div key={course.id} className="flex items-center gap-2 px-2 py-1.5 rounded-xl hover:bg-[#f0f4f8] dark:hover:bg-slate-700 transition-colors group">
                  <button
                    className="flex-1 text-left text-xs font-semibold text-[#073b4c] dark:text-slate-200 truncate"
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-black text-[#073b4c] dark:text-slate-100 tracking-tight">My Courses</h1>
          <p className="text-[#073b4c]/50 dark:text-slate-400 font-medium mt-1">
            {classrooms.length} course{classrooms.length !== 1 ? 's' : ''}
            {classrooms.length > 0 && <span className="ml-2 text-[11px] font-medium text-[#073b4c]/30 dark:text-slate-600">· drag one onto another to group</span>}
          </p>
        </div>
      </div>

      {classrooms.length === 0 ? (
        <div className="h-80 flex flex-col items-center justify-center border-[3px] border-dashed border-[#073b4c]/15 dark:border-slate-700 rounded-3xl">
          <div className="size-20 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mb-4">
            <BookOpen className="size-10 text-[#073b4c]/20 dark:text-slate-600" />
          </div>
          <h3 className="text-xl font-black text-[#073b4c] dark:text-slate-100 mb-2">No courses yet</h3>
          <p className="text-[#073b4c]/50 dark:text-slate-400 font-medium text-sm">Create your first course with AI</p>
        </div>
      ) : (
        <>
          {/* Groups section */}
          {groupList.length > 0 && (
            <div className="mb-8">
              <h2 className="text-xs font-black text-[#073b4c]/40 dark:text-slate-500 uppercase tracking-widest mb-4">
...
function MyCourseCard({
  ...
  return (
    <div className="group cursor-pointer flex flex-col" onClick={handleCardClick}>
      ...
      <div
        ref={thumbRef}
        className="relative w-full aspect-[16/9] rounded-2xl bg-slate-100 dark:bg-slate-800/80 overflow-hidden transition-all duration-200 group-hover:scale-[1.02] group-hover:shadow-[4px_4px_0_#073b4c] border-[2px] border-transparent group-hover:border-[#073b4c]"
      >
        <AnimatePresence>
          {syncing && (
      ...
      <div className="mt-3 flex-1 flex flex-col gap-2 px-0.5">
        {editing ? (
          ...
          <p className="font-bold text-[14px] text-[#073b4c] line-clamp-2 leading-snug">{classroom.name}</p>
        )}

        <div className="flex items-center justify-between text-[11px] text-[#073b4c]/40 font-medium">
        ...
        <div className="space-y-1">
          <div className="flex items-center justify-between text-[11px] font-bold">
            ...
            <span className="text-[#073b4c]/40">{visitedScenes}/{classroom.sceneCount} scenes</span>
          </div>
          <div className="h-2 w-full rounded-full bg-[#073b4c]/8 overflow-hidden">
            <motion.div
              initial={{ width: 0 }}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <button
          onClick={onBack}
          className="flex items-center gap-2 px-4 py-2 rounded-xl border-2 border-[#073b4c]/20 text-[#073b4c]/60 hover:border-[#073b4c] hover:text-[#073b4c] font-bold text-sm transition-all"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Title + tags */}
          <div>
            <h1 className="text-3xl font-black text-[#073b4c] tracking-tight leading-tight mb-4">{title}</h1>
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              {language && (
                <span className="px-3 py-1 bg-[#f0f4f8] text-[#073b4c] text-xs font-bold rounded-lg border-2 border-[#073b4c]/20">
            ...
            {(description || headline) && (
              <p className="text-[#073b4c]/70 font-medium leading-relaxed text-[14px]">
                {description || headline}
              </p>
            )}
          </div>
          ...
          {scenes && scenes.length > 0 && (
            <div>
              <h2 className="text-xs font-black text-[#073b4c]/40 uppercase tracking-widest mb-3">
                Course Contents · {scenes.length} scenes
              </h2>
              <div className="space-y-1.5">
                {scenes.map((scene, i) => (
                  <div key={scene.id} className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-[#f0f4f8] border-2 border-transparent hover:border-[#073b4c]/10 transition-colors">
                    <span className="shrink-0 text-[11px] font-black text-[#073b4c]/30 w-5 text-right tabular-nums">{i + 1}</span>
                    <span className="text-sm shrink-0">{sceneIcon(scene.type)}</span>
                    <span className="font-semibold text-sm text-[#073b4c] truncate">{scene.title}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          {!isMyCourse && (!scenes || scenes.length === 0) && slideCount != null && (
            <div>
              ...
              <div className="h-24 flex items-center justify-center border-[3px] border-dashed border-[#073b4c]/10 rounded-2xl">
                <p className="text-sm text-[#073b4c]/40 font-medium">Save the course to explore scene details</p>
              </div>
            </div>
          )}
        ...
        <div className="lg:col-span-1">
          <div
            ref={thumbRef}
            className="w-full aspect-[16/9] rounded-2xl border-[3px] border-[#073b4c] overflow-hidden bg-slate-100 shadow-[6px_6px_0_#073b4c]"
          >
...
function BrowseCoursesTab({ onSelectCourse }: { onSelectCourse: (course: Course) => void }) {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-black text-[#073b4c] tracking-tight flex items-center gap-3">
            Browse Courses
            <Sparkles className="size-6 text-[#ef476f]" />
          </h1>
          <p className="text-[#073b4c]/50 font-medium mt-1">Discover courses from the community</p>
        </div>
      </div>
      ...
      <div className="flex gap-8">
        ...
        <aside className="hidden lg:block w-52 shrink-0 space-y-6">
          <div>
            <h3 className="text-xs font-black text-[#073b4c]/40 uppercase tracking-widest mb-3 flex items-center gap-2">
                ...
                <button key={sub} onClick={() => setSelectedSubject(sub)}
                  className={cn('px-3 py-2 text-left text-sm font-bold rounded-xl border-2 transition-all',
                    selectedSubject === sub
                      ...
                      : 'bg-transparent text-[#073b4c]/50 border-transparent hover:border-[#073b4c]/15 hover:bg-[#f0f4f8]',
                  )}>
                  {sub}
                </button>
              ))}
        ...
        <div className="flex-1">
          {loading ? (
            <div className="h-64 flex flex-col items-center justify-center gap-4">
              <Loader2 className="size-10 text-[#118ab2] animate-spin" />
              <p className="font-bold text-[#073b4c]/40">Scanning library…</p>
            </div>
          ) : courses.length > 0 ? (
            <>
              ...
              {!hasMore && courses.length > 0 && <p className="text-center text-sm text-[#073b4c]/30 font-medium py-8">All courses loaded</p>}
            </>
          ) : (
            <div className="h-80 flex flex-col items-center justify-center border-[3px] border-dashed border-[#073b4c]/15 rounded-3xl">
              ...
              <h3 className="text-xl font-black text-[#073b4c] mb-2">No courses found</h3>
              <p className="text-[#073b4c]/50 font-medium text-sm">Try adjusting your filters</p>
            </div>
          )}
        </div>
      </div>
...
function BrowseCourseCard({ course, index, onClick }: { course: Course; index: number; onClick: () => void }) {
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      onClick={onClick}
      className="group cursor-pointer flex flex-col bg-white border-[3px] border-[#073b4c] rounded-2xl overflow-hidden shadow-[5px_5px_0_#073b4c] hover:shadow-[8px_8px_0_#073b4c] transition-all"
    >
      <div className="h-32 bg-gradient-to-br from-slate-50 to-slate-100 border-b-[3px] border-[#073b4c] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="p-4 flex-1 flex flex-col">
        <h3 className="text-[15px] font-black text-[#073b4c] mb-2 line-clamp-2 leading-tight group-hover:text-[#ef476f] transition-colors">
          {course.title}
        </h3>
        <p className="text-[#073b4c]/60 text-xs font-medium line-clamp-2 mb-4 flex-1">
          {course.headline || course.description}
        </p>
        <div className="pt-3 border-t-2 border-[#073b4c]/8 flex items-center justify-between">
          <span className="text-[11px] font-black text-[#073b4c]/30 uppercase tracking-widest">
            {course.slideCount} Slides
          </span>
          <div className="size-7 bg-[#073b4c] rounded-full flex items-center justify-center text-white group-hover:bg-[#ef476f] transition-colors">
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-[#073b4c]/50 font-medium mt-1">Your learning milestones and leaderboard ranking</p>
      </div>

      {/* ── Personal stats ── */}
      <section>
        <p className="text-[11px] font-black text-[#073b4c]/35 uppercase tracking-widest mb-4">Your Stats</p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {([
            ...
            <motion.div
              ...
              className={cn(
                'relative rounded-2xl border-[3px] border-[#073b4c] bg-gradient-to-br p-5 flex flex-col gap-3',
                card.bgClass,
                card.onClick
            ...
            >
              ...
              <div>
                {card.value === null ? (
                  ...
                  <p className="text-3xl font-black text-[#073b4c] leading-none">
                    {card.value}
                    {card.unit && <span className="text-base font-bold text-[#073b4c]/50 ml-1">{card.unit}</span>}
                  </p>
                )}
                <p className="text-xs font-black text-[#073b4c]/60 uppercase tracking-wide mt-1">{card.label}</p>
                <p className="text-[10px] text-[#073b4c]/35 font-medium mt-0.5">{card.sub}</p>
              </div>
      ...
      <AnimatePresence>
        {certsOpen && (
          ...
          >
            <div className="rounded-2xl border-[3px] border-[#8338ec] bg-white shadow-[5px_5px_0_#8338ec] overflow-hidden">
              <div className="flex items-center justify-between px-5 py-3.5 border-b-2 border-[#8338ec]/15 bg-violet-50/60">
      ...
      {/* ── Your rank ── */}
      {currentUserEntry && (
        <div className="p-5 rounded-2xl border-[3px] border-[#ffd166] bg-gradient-to-r from-[#fffbea] to-[#fffef5] shadow-[4px_4px_0_#ffd166] flex items-center gap-5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[10px] font-black text-[#073b4c]/40 uppercase tracking-widest">Your Global Rank</p>
            <p className="text-4xl font-black text-[#073b4c] leading-tight">#{currentUserEntry.rank}</p>
          </div>
          <div className="text-right shrink-0">
            <p className="text-[10px] font-black text-[#073b4c]/40 uppercase tracking-widest">Quiz Score</p>
            <p className="text-2xl font-black text-[#073b4c]">{currentUserEntry.total_score.toLocaleString()}</p>
            <p className="text-[10px] font-bold text-[#073b4c]/30">{currentUserEntry.quizzes_completed} quizzes</p>
          </div>
        </div>
      )}
      ...
      {/* ── Leaderboard ── */}
      <section>
        <p className="text-[11px] font-black text-[#073b4c]/35 uppercase tracking-widest mb-4">Leaderboard</p>
        <div className="rounded-2xl border-[3px] border-[#073b4c] bg-white shadow-[5px_5px_0_#073b4c] overflow-hidden">
          <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b-[3px] border-[#073b4c]">
            <div className="flex gap-2">
              {(['global', 'local'] as const).map((t) => (
                <button key={t} onClick={() => setLbTab(t)}
                  className={cn('px-4 py-2 rounded-xl font-bold text-sm border-2 transition-all',
                    lbTab === t ? 'bg-[#073b4c] text-white border-[#073b4c]' : 'text-[#073b4c]/60 border-transparent hover:border-[#073b4c]/20',
                  )}>
          ...
          {lbTab === 'local' && (
            <div className="px-5 py-3 border-b-2 border-[#073b4c]/10 bg-[#f8fafc]">
              <div className="flex flex-wrap gap-2 items-center">
                <span className="text-xs font-black text-[#073b4c]/40 uppercase tracking-widest shrink-0">Country:</span>
                ...
                <div className="flex-1 min-w-0 relative max-w-xs">
                  ...
                  <input value={searchCountry} onChange={(e) => setSearchCountry(e.target.value)}
                    ...
                    className="w-full h-7 pl-8 pr-3 text-xs font-medium border-2 border-[#073b4c]/20 rounded-full focus:outline-none focus:border-[#073b4c]/50 bg-white" />
                </div>
              </div>
              {searchCountry && (
          ...
          {lbLoading ? (
            ...
            <div className="h-40 flex flex-col items-center justify-center gap-2">
              <Trophy className="size-10 text-[#073b4c]/10" />
              <p className="text-sm font-bold text-[#073b4c]/30">No data yet</p>
            </div>
          ) : (
            <div className="divide-y divide-[#073b4c]/6">
              {lbData.map((entry, i) => {
                ...
                return (
                  <motion.div key={entry.user_id}
                    ...
                    className={cn('flex items-center gap-4 px-5 py-3.5 transition-colors',
                      isCurrentUser ? 'bg-[#fffbea]' : 'hover:bg-[#f8fafc]',
                    )}>
                    <div className="w-8 text-center shrink-0 font-black text-sm text-[#073b4c]/50">
                      {i < 3 ? <span className="text-xl">{['🥇','🥈','🥉'][i]}</span> : `#${entry.rank}`}
                    </div>
                    <div className="size-9 rounded-full overflow-hidden border-2 border-[#073b4c]/15 shrink-0 bg-gradient-to-br from-[#118ab2] to-[#06d6a0] flex items-center justify-center">
                      {entry.avatar_url
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={cn('font-bold text-sm text-[#073b4c] truncate', isCurrentUser && 'text-[#8338ec]')}>
                        {entry.display_name || 'Anonymous'}
                        {isCurrentUser && <span className="ml-2 text-[9px] bg-[#8338ec] text-white rounded-full px-1.5 py-0.5 font-black">You</span>}
                      </p>
                      <p className="text-[11px] text-[#073b4c]/35 font-medium">{entry.quizzes_completed} quiz{entry.quizzes_completed !== 1 ? 'zes' : ''}</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="font-black text-[#073b4c] text-sm">{entry.total_score.toLocaleString()}</p>
                      <p className="text-[9px] text-[#073b4c]/25 font-bold uppercase tracking-wide">pts</p>
                    </div>
                  </motion.div>
                );
              })}
...
function DashboardPage() {
  ...
  return (
    <div className="h-[100dvh] w-full bg-[#f8fafc] dark:bg-[#0f172a] flex overflow-hidden">
      {/* Sidebar */}
      <Sidebar
        activeTab={activeTab}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <button
          ...
          className="lg:hidden fixed top-4 left-4 z-30 size-10 rounded-xl border-2 border-[#073b4c]/15 bg-white shadow-sm flex items-center justify-center hover:bg-[#f0f4f8] transition-colors"
        >
